import { LayoutDashboard, PlusCircle, Wallet, User, Zap, Sun, Moon, LogOut, Globe, Code, BookOpen } from "lucide-react"
...
const navItems = [
  ...
  { title: "My Sites", url: "/sites", icon: Globe },
  { title: "SDK Generator", url: "/sdk-generator", icon: Code },
  { title: "SDK Docs", url: "/sdk-docs", icon: BookOpen },
